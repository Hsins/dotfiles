...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(user context dir dir_writable vcs newline os_icon anaconda)
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/hsins/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/hsins/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/hsins/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
conda deactivate
